...
public val SocialPack.Whatsapp2: ImageVector
    get() {
        if (_whatsapp2 != null) {
            return _whatsapp2!!
        }
        _whatsapp2 = Builder(name = "Whatsapp2", defaultWidth = 32.0.dp, defaultHeight = 32.0.dp,
...
private var _whatsapp2: ImageVector? = null

@Preview
@Composable
private fun Preview(): Unit {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = SocialPack.Whatsapp2, contentDescription = "")
    }
}
